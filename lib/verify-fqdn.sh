...
######################################################################################
#                                                                                    #
# Hydrodactyl Installer - FQDN Verification                                           #
#                                                                                    #
...
if ! fn_exists lib_loaded; then
  ...
  if ! fn_exists lib_loaded; then
    # shellcheck source=/dev/null
    source <(curl -fsSL "${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/itzzjustmateo/hydro-install"}/${GITHUB_SOURCE:-"main"}/lib/lib.sh") || true
  fi
