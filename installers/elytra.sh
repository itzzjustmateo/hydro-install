...
# Installation paths
# Use ELYTRA_INSTALL_DIR to avoid collision with lib.sh's INSTALL_DIR (which is /var/www/hydrodactyl for the panel)
...
install_elytra() {
  ...
  echo "$target_release" > /etc/hydrodactyl/elytra-version
